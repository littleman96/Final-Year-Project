...
<html>
	...
	<body>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							<h1 style="color:black;"> Your Project has been Updated </h1>
							<ul class="breadcrumb">
		...
		<?php
			...
			$sql = "UPDATE volunteerprojects SET VolunteerProjectName = '$VolunteerProjectName', VolunteerProjectDescription = '$VolunteerProjectDescription', VolunteerProjectSkillNeed1 = '$VolunteerProjectSkillNeed1', VolunteerProjectSkillNeed2 = '$VolunteerProjectSkillNeed2', VolunteerProjectSkillNeed3 = '$VolunteerProjectSkillNeed3', VolunteerProjectSkillDevelop1 = '$VolunteerProjectSkillDevelop1', VolunteerProjectSkillDevelop2 = '$VolunteerProjectSkillDevelop2', VolunteerProjectSkillDevelop3 = '$VolunteerProjectSkillDevelop3', MonAM = '$MonAM', MonPM = '$MonPM', TueAM = '$TueAM', TuePM = '$TuePM', WedAM = '$WedAM', WedPM = '$WedPM', ThuAM = '$ThuAM', ThuPM = '$ThuPM', FriAM = '$FriAM', FriPM = '$FriPM', SatAM = '$SatAM', SatPM = '$SatPM', SunAM = '$SunAM', SunPM = '$SunPM', ApplicationCloseDate = '$ApplicationCloseDate', StartDate= '$StartDate' ,Number = '$Number', Street = '$Street', Town = '$Town', Postcode = '$Postcode' WHERE VolunteerProjectID = '$VolunteerProjectID'";
