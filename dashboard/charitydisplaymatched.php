<html>
	...
	<div id="page-header">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							<h1 style="color:black;">Volunteers Matched to the Project</h1>
							<ul class="breadcrumb">
							
							<li class="active" style="color:black">
								<br>  These are the volunteers that have been matched to the project selected.
								<br>
								<br>
								<br>
		...
		<?php
			...
			$sql = "SELECT * FROM studentvolunteerusernames s, matchedstudentprojects m WHERE s.StudentUsername = m.StudentUsername AND m.VolunteerProjectID = '$VolunteerProjectID'";
