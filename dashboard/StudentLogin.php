...
<div class="login">
			<h1>Login</h1>
			<form action="authenticate_student.php" method="post">
		...
		<center><p><h2 style="color:white;">New Users Please <a href=studentnewaccount.php> <h2 style="color:white;"> Register Here </a> </h2> </p> </center>
	<!-- FOOTER -->
