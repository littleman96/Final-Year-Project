...
<html>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							<h1 style="color:black;"> Create your new project below </h1>
							<ul class="breadcrumb">
	...
	if (!isset($_SESSION['charityloggedin']))
	{
		...
		if($_POST)
		{
			$VolunteerProjectName = $_POST['VolunteerProjectName'];

			$CharityName = $_POST['CharityName'];
			
			
			$VolunteerProjectDescription = $_POST['VolunteerProjectDescription'];
			...
			$ApplicationCloseDate = $_POST['ApplicationCloseDate'];
			...
			$sql = "INSERT INTO volunteerprojects (VolunteerProjectName, CharityName, VolunteerProjectDescription, VolunteerProjectSkillNeed1, VolunteerProjectSkillNeed2, VolunteerProjectSkillNeed3, VolunteerProjectSkillDevelop1, VolunteerProjectSkillDevelop2, VolunteerProjectSkillDevelop3, MonAM, MonPM, TueAM, TuePM, WedAM, WedPM, ThuAM, ThuPM, FriAM, FriPM, SatAM, SatPM, SunAM, SunPM, ApplicationCloseDate, StartDate, Number, Street, Town, Postcode, CreatedBy) 
			VALUES ('$VolunteerProjectName', '$CharityName', '$VolunteerProjectDescription', '$VolunteerProjectSkillNeed1', '$VolunteerProjectSkillNeed2', '$VolunteerProjectSkillNeed3', '$VolunteerProjectSkillDevelop1', '$VolunteerProjectSkillDevelop2', '$VolunteerProjectSkillDevelop3', '$MonAM', '$MonPM', '$TueAM', '$TuePM', '$WedAM', '$WedPM', '$ThuAM', '$ThuPM', '$FriAM', '$FriPM', '$SatAM', '$SatPM', '$SunAM', '$SunPM', '$ApplicationCloseDate', '$StartDate', '$Number', '$Street', '$Town', '$Postcode', '$_SESSION[CharityUsername]')";
			...
			$sql2 = "INSERT INTO skills (Skill) VALUES ('$VolunteerProjectSkillDevelop1'), ('$VolunteerProjectSkillDevelop2'), ('$VolunteerProjectSkillDevelop3'), ('$VolunteerProjectSkillNeed1'), ('$VolunteerProjectSkillNeed2'), ('$VolunteerProjectSkillNeed3')"; 
