...
<?php
	...
	$sql = "SELECT VolunteerProjectID, VolunteerProjectName FROM volunteerprojects WHERE CreatedBy = '$_SESSION[CharityUsername]'";
...
<html>
	...
	<div id="page-header">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							<h1 style="color:black;"> View your projects below</h1>
							<ul class="breadcrumb">
		...
		<form action="displayproject.php" method="post">
