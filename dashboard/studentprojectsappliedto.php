<html>
	...
	<div id="page-header">
					...
					<div class="col-md-12">
						<div class="header-content">
							...
							<li class="active" style="color:black">
								<br>These are the projects that you have applied to.
								<br>
								<br>
								<br>
		...
		<?php
			...
			$sql = "SELECT * FROM applied a, volunteerprojects v WHERE v.VolunteerProjectID = a.VolunteerProjectID AND a.StudentUsername = '$StudentUsername' AND v.StartDate >= CURRENT_DATE()";
			...
			if ($result->num_rows > 0)
			{
				while($row = $result->fetch_assoc())
				{
					...
					echo "<br> Charity: ". $row["CharityName"];
