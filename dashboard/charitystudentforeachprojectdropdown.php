<?php
	...
	$sql = "SELECT * FROM volunteerprojects v, matchedstudentprojects m WHERE v.CreatedBy = '$_SESSION[CharityUsername]' AND m.VolunteerProjectID = v.VolunteerProjectID";
...
<html>
	...
	<div id="page-header">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							<h1 style="color:black;"> View your projects matched to students</h1>
							<ul class="breadcrumb">
							
							<li class="active" style="color:black">
								<br>  You can view all the projects that have been matched with at least one volunteer or more. You can then view the volunteers for that project along with their contact information.
								<br>
								<br>
								<br>
		...
		<form action="charitydisplaymatched.php" method="post">
			<select name="VolunteerProjectID">
				<option value ="null">select</option>
				<?php foreach ( $results as $option ) : ?>
				<option value="<?php echo $option->VolunteerProjectID; ?>"><?php echo $option->VolunteerProjectName; ?></option>
				<?php endforeach; ?>
			</select>
		<br><input type="submit" value ="View/Edit" required = "required">
		</form>	
			</div>
			</div>
