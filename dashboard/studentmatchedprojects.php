<html>
	...
	<div id="page-header">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							<h1 style="color:black;">Projects Matched / Completed</h1>
							<ul class="breadcrumb">
							
							<li class="active" style="color:black">
								<br>  These are the volunteering projects that you have been matched with and possibly completed as well.
								<br>
								<br>
								<br>
		...
		<?php
			...
			$sql = "SELECT *  FROM volunteerprojects v, matchedstudentprojects m WHERE v.VolunteerProjectID = m.VolunteerProjectID AND m.StudentUsername = '$StudentUsername'";
