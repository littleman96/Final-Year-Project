...
<html>
	...
	<body>
		...
		<!-- need to ass required = "required to all below when testing has been done"-->
		
		Name of Project: <input type="text" name="VolunteerProjectName" required>
		<br>
		<br>
		Charity Name:  <input type="text" name="CharityName" required>
		<br>
		<br>
		Description of project: <input type="text" name="VolunteerProjectDescription" required>
		<br>
		<br>
		
		<h3>Current Skills</h3>
		<br>
		Skill1: <input type="text" name="VolunteerProjectSkillNeed1" required>
		Skill2: <input type="text" name="VolunteerProjectSkillNeed2" required>
		Skill3: <input type="text" name="VolunteerProjectSkillNeed3" required>
		<br>
		<br>
		<h3>Skills To Gain</h3>
		<br>
		SkillGain1: <input type="text" name="VolunteerProjectSkillDevelop1" required>
		SkillGain2: <input type="text" name="VolunteerProjectSkillDevelop2" required>
		SkillGain3: <input type="text" name="VolunteerProjectSkillDevelop3" required>
		<br>
		<br>
		
		<h3>Time available</h3> <!-- Need to sort out the null values for the radio buttons -->
		<p>
		...
		Application Close Date:  <input type="date" name="ApplicationCloseDate" required>
		<br>
		<br>
		...
		<h3>Address</h3>
		Number/Name: <input type="text" name="Number" required><br>
		<br>
