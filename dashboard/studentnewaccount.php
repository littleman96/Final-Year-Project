...
<header>
		...
		<div class="register">
			<h1>Register</h1>
			<form action="studentnewaccountregister.php" method="post" autocomplete="off">
				<label for="StudentUsername">
					<i class="fas fa-user"></i>
				</label>
				<input type="text" name="StudentUsername" placeholder="Username" id="StudentUsername" required>
				
				<label for="StudentPassword">
					<i class="fas fa-lock"></i>
				</label>
			
				<input type="password" name="StudentPassword" placeholder="Password" id="StudentPassword" required>
				
				<label for="StudentVolunteerEmail">
					<i class="fas fa-envelope"></i>
				</label>
				<input type="email" name="StudentVolunteerEmail" placeholder="Email" id="StudentVolunteerEmail" required>
