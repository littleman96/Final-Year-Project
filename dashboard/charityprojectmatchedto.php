...
<?php
	...
	$sql = "SELECT DISTINCT * FROM volunteerprojects v, applied a WHERE v.CreatedBy = '$_SESSION[CharityUsername]' AND a.VolunteerProjectID = v.VolunteerProjectID AND v.StartDate >= CURRENT_DATE()";
...
<html>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
		...
		<title>Projects Applied To</title>
	...
	<body>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							<h1 style="color:black;"> Projects Applied To</h1>
							<ul class="breadcrumb">
				<li class="active" style="color:black">
								<br> Please use the navigation below to see the projects that have been applied to.
								<br>
								<br>
								<br>
		...
		<form action="displayapplicants.php" method="post">
		...
		<br><input type="submit" value ="View" required = "required">
		</form>	
