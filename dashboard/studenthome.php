				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							...
							<ul class="breadcrumb">
								<li><a href="index.html">Home</a></li>
								<li class="active"><h2>Welcome to Voluntario </h2>
								<br>This is the Student Volunteer home page.
	 							<br>This helps them develop their current skills as well as build new skills.
								<br>At Voluntario we will match university students to a volunteering project using various drifferent criterea such as current skills and skills that they would like to gain. 
								<br>This will help to find the perfect match to a volunteering project and help develop your skills.									
								</p>
								<br></li>
							</ul>
						</div>
