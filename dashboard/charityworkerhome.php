...
<?php
	...
	{
		header('Location: charityworkerlogin.php');
		exit();
	}
					...
					<div class="col-md-12">
						<div class="header-content">
							...
							<ul class="breadcrumb">
								...
								<br> You can create and edit your volunteering projects on the Projects link above.
								<br> Once you have created and submitted your projects applicants can view them and apply.
								<br> You will then be able to see their emails to get in touch and find the perfect candidate!
								<br></li>
							</ul>
						</div>
					</div>
