...
<html>
	...
	<title>Student Matched With Project</title>
	...
	<div id="page-header">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="header-content">
							<h1 style="color:black;">Matching the project</h1>
							<ul class="breadcrumb">
		...
		<?php
			...
			$sql = "INSERT INTO matchedstudentprojects (VolunteerProjectID, StudentUsername) VALUES ('$VolunteerProjectID','$StudentUsername')";
			
			if ($con->query($sql) === TRUE)
			{
				echo "Student matched with project.";
			}
			else
			{
